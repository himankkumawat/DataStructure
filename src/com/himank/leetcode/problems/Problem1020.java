...
public class Problem1020 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("No of island which cannot be walked by boundary of grid: " + numEnclaves(grid));
    }

    public static void dfs(int x, int y, int m, int n, int[][] grid, boolean[][] visit) {
