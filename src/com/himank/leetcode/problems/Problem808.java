...
public class Problem808 {
    ...
    public static void main(String[] args) {
        System.out.println("probability that soup A will be empty first, plus half the probability that A and B become " +
                "empty at the same time " + soupServings(50));
    }
    ...
    private static double calculateDP(int i, int j, Map<Integer, Map<Integer, Double>> dp) {
